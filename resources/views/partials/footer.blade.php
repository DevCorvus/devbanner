...
<footer id="footer" class="flex justify-between flex-wrap mt-6 rounded-t-xl p-2" style="background: linear-gradient(to right, #2b5876, #4e4376);">
  ...
  <ul class="flex items-center w-2/3 sm:w-auto mt-2 lg:mt-0 order-last flex-wrap lg:order-none text-xl font-medium gap-4">
    <li>
      <a href="{{ route('terms') }}">
        <div class="flex items-center transition duration-200 border-b-4 border-transparent hover:border-purple-300">
  ...
  <div class="text-4xl flex">
    <div class="w-24">
      <a href="{{ route('contact') }}" title="Social Media">
